 ...
 * 
 */
public class CreateMergeClientImpl {
	...
	public CreateMergeClientImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Client input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_MERGE_CLIENT, //
	...
	* The 'createMerge' request primitive for the Client entity.
	*/
	public CompletableFuture<Client> createMergeClientRequest(Client input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
