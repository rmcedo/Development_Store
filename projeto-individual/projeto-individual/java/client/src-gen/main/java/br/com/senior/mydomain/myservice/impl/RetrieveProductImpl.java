...
public class RetrieveProductImpl {
	...
	private Message createMessage(Product.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.RETRIEVE_PRODUCT, //
	...
	* The 'retrieve' request primitive for the Product entity.
	*/
	public CompletableFuture<Product> retrieveProductRequest(Product.GetRequest input, long timeout, TimeUnit unit) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Product.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
