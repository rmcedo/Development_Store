...
import br.com.senior.mydomain.myservice.CreateBulkClientInput;
import br.com.senior.mydomain.myservice.CreateBulkClientOutput;
 ...
 * 
 */
public class CreateBulkClientImpl {
	...
	public CreateBulkClientImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkClientInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_BULK_CLIENT, //
	...
	*/
	public CreateBulkClientOutput createBulkClient(CreateBulkClientInput input, long timeout) {
		...
		CreateBulkClientOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkClientOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CreateBulkClientOutput> createBulkClientRequest(CreateBulkClientInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkClientOutput.class);
	}
	...
	* The 'createBulk' request primitive for the Client entity.
	*/
	public CompletableFuture<CreateBulkClientOutput> createBulkClientRequest(CreateBulkClientInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkClientOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
