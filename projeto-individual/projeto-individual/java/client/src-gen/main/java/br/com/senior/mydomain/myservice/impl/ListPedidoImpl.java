...
public class ListPedidoImpl {
	...
	private Message createMessage(Pedido.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.LIST_PEDIDO, //
	...
	* The 'list' request primitive for the Pedido entity.
	*/
	public CompletableFuture<Pedido.PagedResults> listPedidoRequest(Pedido.PageRequest input, long timeout, TimeUnit unit) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Pedido.PagedResults.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
