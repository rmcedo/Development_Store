 ...
 * 
 */
public class CreatePedido_ItemsImpl {
	...
	public CreatePedido_ItemsImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Item input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_PEDIDO_ITEMS, //
	...
	* The 'create' request primitive for the items attribute of pedido entity.\nThis primitive requires the header 'entity_parent_id' with id of parent pedido entity.
	*/
	public CompletableFuture<Item> createPedido_ItemsRequest(Pedido.Id parentId, Item input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
