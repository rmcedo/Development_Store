...
public class CreateClientImpl {
	...
	public CreateClientImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Client input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_CLIENT, //
	...
	* The 'create' request primitive for the Client entity.
	*/
	public CompletableFuture<Client> createClientRequest(Client input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
