...
import br.com.senior.mydomain.myservice.ImportPedidoInput;
import br.com.senior.mydomain.myservice.ImportPedidoOutput;
...
public class ImportPedidoImpl {
	...
	private Message createMessage(ImportPedidoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.IMPORT_PEDIDO, //
	...
	* 
	*/
	public CompletableFuture<ImportPedidoOutput> importPedidoRequest(ImportPedidoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportPedidoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
