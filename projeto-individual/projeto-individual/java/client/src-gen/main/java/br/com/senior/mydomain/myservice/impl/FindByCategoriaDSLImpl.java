...
import br.com.senior.mydomain.myservice.FindByCategoriaDSLInput;
import br.com.senior.mydomain.myservice.FindByCategoriaDSLOutput;
 ...
 * 
 */
public class FindByCategoriaDSLImpl {
	...
	public FindByCategoriaDSLImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(FindByCategoriaDSLInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.FIND_BY_CATEGORIA_DSL, //
	...
	*/
	public FindByCategoriaDSLOutput findByCategoriaDSL(FindByCategoriaDSLInput input, long timeout) {
		...
		FindByCategoriaDSLOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), FindByCategoriaDSLOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<FindByCategoriaDSLOutput> findByCategoriaDSLRequest(FindByCategoriaDSLInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, FindByCategoriaDSLOutput.class);
	}
	...
	* Query destinada para retornar lista de produtos dentro da categoria passada
	*/
	public CompletableFuture<FindByCategoriaDSLOutput> findByCategoriaDSLRequest(FindByCategoriaDSLInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, FindByCategoriaDSLOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
