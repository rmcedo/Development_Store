...
public class UpdateClientImpl {
	...
	public UpdateClientImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Client input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_CLIENT, //
	...
	* The 'update' request primitive for the Client entity.
	*/
	public CompletableFuture<Client> updateClientRequest(Client input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
