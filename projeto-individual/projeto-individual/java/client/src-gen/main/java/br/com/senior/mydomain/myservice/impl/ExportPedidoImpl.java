...
import br.com.senior.mydomain.myservice.ExportPedidoInput;
import br.com.senior.mydomain.myservice.ExportPedidoOutput;
...
public class ExportPedidoImpl {
	...
	private Message createMessage(ExportPedidoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.EXPORT_PEDIDO, //
	...
	* 
	*/
	public CompletableFuture<ExportPedidoOutput> exportPedidoRequest(ExportPedidoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportPedidoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
