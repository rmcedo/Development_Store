 ...
 * 
 */
public class UpdateMergePedido_ItemsImpl {
	...
	public UpdateMergePedido_ItemsImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Item input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_PEDIDO_ITEMS, //
	...
	* The 'updateMerge' request primitive for the items attribute of pedido entity.\nThis primitive requires the header 'entity_parent_id' with id of parent pedido entity.
	*/
	public CompletableFuture<Item> updateMergePedido_ItemsRequest(Pedido.Id parentId, Item input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
