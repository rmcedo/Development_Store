...
import br.com.senior.mydomain.myservice.ExportProductInput;
import br.com.senior.mydomain.myservice.ExportProductOutput;
...
public class ExportProductImpl {
	...
	private Message createMessage(ExportProductInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.EXPORT_PRODUCT, //
	...
	* 
	*/
	public CompletableFuture<ExportProductOutput> exportProductRequest(ExportProductInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportProductOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
