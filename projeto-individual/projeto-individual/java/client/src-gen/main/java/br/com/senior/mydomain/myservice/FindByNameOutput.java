...
public class FindByNameOutput {
    ...
    public FindByNameOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public FindByNameOutput(java.util.List<Client> response) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FindByNameOutput)) {
            return false;
        }
        FindByNameOutput other = (FindByNameOutput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	FindByNameOutputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
