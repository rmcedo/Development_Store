...
public class ProductEntityStringSerializer {
	...
	protected void serializeCategoria(ProductEntity product, StringBuilder sb) {
		sb.append("categoria=").append(product.getCategoria() == null ? "null" : product.getCategoria());
	}
}
