...
import br.com.senior.mydomain.myservice.ImportProductInput;
import br.com.senior.mydomain.myservice.ImportProductOutput;
...
public class ImportProductImpl {
	...
	private Message createMessage(ImportProductInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.IMPORT_PRODUCT, //
	...
	* 
	*/
	public CompletableFuture<ImportProductOutput> importProductRequest(ImportProductInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportProductOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
