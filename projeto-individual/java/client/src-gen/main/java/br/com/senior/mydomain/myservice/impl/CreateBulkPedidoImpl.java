...
import br.com.senior.mydomain.myservice.CreateBulkPedidoInput;
import br.com.senior.mydomain.myservice.CreateBulkPedidoOutput;
...
public class CreateBulkPedidoImpl {
	...
	private Message createMessage(CreateBulkPedidoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_BULK_PEDIDO, //
	...
	* The 'createBulk' request primitive for the Pedido entity.
	*/
	public CompletableFuture<CreateBulkPedidoOutput> createBulkPedidoRequest(CreateBulkPedidoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkPedidoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
