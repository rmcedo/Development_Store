...
import br.com.senior.mydomain.myservice.FindPriceGreaterInput;
import br.com.senior.mydomain.myservice.FindPriceGreaterOutput;
 ...
 * 
 */
public class FindPriceGreaterImpl {
	...
	public FindPriceGreaterImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(FindPriceGreaterInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.FIND_PRICE_GREATER, //
	...
	*/
	public FindPriceGreaterOutput findPriceGreater(FindPriceGreaterInput input, long timeout) {
		...
		FindPriceGreaterOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), FindPriceGreaterOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<FindPriceGreaterOutput> findPriceGreaterRequest(FindPriceGreaterInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, FindPriceGreaterOutput.class);
	}
	...
	*/
	public CompletableFuture<FindPriceGreaterOutput> findPriceGreaterRequest(FindPriceGreaterInput input, long timeout, TimeUnit unit) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, FindPriceGreaterOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
