 ...
 * 
 */
public class UpdateMergeClientImpl {
	...
	public UpdateMergeClientImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Client input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.UPDATE_MERGE_CLIENT, //
	...
	* The 'updateMerge' request primitive for the Client entity.
	*/
	public CompletableFuture<Client> updateMergeClientRequest(Client input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
