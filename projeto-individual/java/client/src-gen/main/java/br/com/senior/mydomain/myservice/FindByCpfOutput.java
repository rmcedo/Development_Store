...
public class FindByCpfOutput {
    ...
    public FindByCpfOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public FindByCpfOutput(java.util.List<Client> response) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FindByCpfOutput)) {
            return false;
        }
        FindByCpfOutput other = (FindByCpfOutput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	FindByCpfOutputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
