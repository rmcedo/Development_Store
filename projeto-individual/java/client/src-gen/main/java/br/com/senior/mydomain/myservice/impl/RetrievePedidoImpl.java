...
public class RetrievePedidoImpl {
	...
	private Message createMessage(Pedido.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.RETRIEVE_PEDIDO, //
	...
	* The 'retrieve' request primitive for the Pedido entity.
	*/
	public CompletableFuture<Pedido> retrievePedidoRequest(Pedido.GetRequest input, long timeout, TimeUnit unit) {
